...
sources: [MS Learn (publication-fundamentals-publish-channels, guidance/channels, publication-add-bot-to-microsoft-teams [last-mod 2026-03-11], adaptive-cards-overview [last-mod 2026-04-24], publication-add-bot-to-sharepoint, publication-connect-bot-to-custom-application [last-mod 2025-11-28], planned-features, whats-new [last-mod 2026-04-23], 2026wave1 release plan + live fetch 2026-04-22, voice-configuration), MCS UI snapshot, WebSearch Apr 2026, M365 Copilot Blog Mar 2026, Dynamics 365 Blog Mar 2026, MC1282727 (Teams classic-agent retirement paused)]
confidence: high
refresh_trigger: weekly
apr_2026_update: "No new channels added. Confirmed: Teams group/channel chats cannot use end-user-auth knowledge sources (1:1 only). M365 Copilot channel limitations surfaced (no OnConversationStart, no GIF/basic cards/video/file/speech, no Action.Execute adaptive cards, inactivity trigger fires but can't post, no reactions). Adaptive Cards: v1.6 schema in default Web Chat (no Action.Execute), v1.5 in Teams and Omnichannel. MC1282727: Teams classic agent creation retirement (scheduled Apr 1 2026) paused, timeline TBD. Apr 24, 2026 doc refresh: adaptive-cards-overview re-confirmed schema versions (no new versions). Mar 2026 accessibility best practices for Adaptive Cards live (screen readers, keyboard nav, Teams-specific scenarios)."
-->
...
- **Apr 13 2026 check:** No new channels added. Channel list remains stable. 2026w1 planned features page confirms no new channel types for Apr-Sep 2026. Key related updates: "Configure triggers with end-user credentials" GA moved to Jul 2026 (was Jun) -- affects autonomous agent triggers across channels, not a new channel. "Intuitive inline deployments in Copilot Studio" Preview Apr 2026 -- improved solution/deployment UX for publishing, not a new channel. "Use single sign-on for non-Entra ID connections" removed from release plan (deprioritized Feb 27 2026) -- impacts auth on non-Teams channels. Voice/IVR: no new features beyond what's already GA (answering machine detection Jan 2026, SIP X-headers Feb 2026). Enhanced DTMF dial pad GA Apr 1 2026 in Dynamics 365 Contact Center (service rep feature, not MCS channel change). Realtime voice mode now a selectable option alongside Basic when enabling voice in agent settings. Guidance hub published "Deploy agents in Microsoft Teams" (Feb 2026) and "Publish agents to channels and clients" architecture guidance (Jan 2026) -- documentation improvements, no capability changes.
- **Apr 27 2026 check:** No new channels added. adaptive-cards-overview doc refreshed Apr 24, 2026 — schema version table re-confirmed: Web Chat (1.6, no `Action.Execute`), live chat widget / Omnichannel for Customer Service (1.5), Teams (1.5), Copilot Studio test chat (1.6 in test chat only, NOT canvas). Mar 2026 accessibility best practices for Adaptive Cards live: screen readers, keyboard navigation, Teams-specific scenarios. Apply when authoring `kind: AdaptiveCard` content in Adaptive Card or Question nodes. Best practices: (1) every input has accessible label, (2) buttons have meaningful titles (not "OK"/"Cancel" alone), (3) provide text alternative when card-only response is the message, (4) ensure unique submit data per card to avoid retroactive confusion when multiple cards visible. whats-new doc Apr 23, 2026 also re-confirmed: Reprompt messages with randomization (Mar 2026 GA) — affects voice + retry-prompt scenarios. Post-call action topics (voice) GA Mar 2026 — voice telephony channel only. WhatsApp adaptive card limits unchanged.
