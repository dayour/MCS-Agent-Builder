...
sources: [MS Learn, MCS UI, community blogs]
confidence: high
...
| **AI Response Generated** | After AI drafts, before sending | Access `Response.FormattedText`. Set `ContinueResponse = false` to suppress. |
| **On Plan Complete** | After plan executes | Cleanup, surveys, end logic. |
...
GPT-4o retired Oct 2025. **GPT-4.1** is default. GPT-5 Chat GA Nov 2025. Generative orchestration available for all supported languages.
