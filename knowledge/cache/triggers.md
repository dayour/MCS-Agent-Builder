...
| `OnInactivity` | The user is inactive | No interaction after configured time | No |
...
| `OnPlanComplete` | A plan completes | Agent finishes all planned steps | No |
| `OnGeneratedResponse` | AI response about to be sent | AI composes draft before sending | No |
